...
(let ((efdh-fg0          "#DDC7A1")
  ...
  (custom-theme-set-faces 'everforest-dark-hard
                          ...
                          `(show-paren-match-face ((t (:inverse-video t :background ,efdh-fg :foreground ,efdh-red))))
                          ...
                          ;; `(hl-line-face ((,class (:background ,efdh-bg4))
                          ;;                 (t :weight bold)))
                          ;; `(hl-line ((,class (:background ,efdh-bg4 :extend t))
                          ;;            (t :weight bold)))

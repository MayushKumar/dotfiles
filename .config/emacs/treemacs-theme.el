...
(treemacs-create-theme "mk/treemacs-theme"
      :config
      (progn
        ;; Set fallback icon
        (treemacs-create-icon
         :icon (format " %s " (all-the-icons-material "description"
                                                    :height 0.9
                                                    :v-adjust -0.2
													:h-adjut
													))
        ...
        (treemacs-create-icon :icon (format " %s " (all-the-icons-alltheicon "git" :height 1.0 :v-adjust 0.05)) :extensions ("gitignore" "git" "gitattributes" "gitconfig" "gitmodules") :fallback 'same-as-icon)
        ...
        (treemacs-create-icon :icon (format " %s " (all-the-icons-alltheicon "c" :height 0.95 :v-adjust 0.02)) :extensions ("c" "h") :fallback 'same-as-icon)
        (treemacs-create-icon :icon (format " %s " (all-the-icons-fileicon "cmake" :height 0.9 :v-adjust 0.01)) :extensions ("cmake" "CMakeCache.txt" "CMakeLists.txt") :fallback 'same-as-icon)
        (treemacs-create-icon :icon (format " %s " (all-the-icons-fileicon "crystal")) :extensions ("cr") :fallback 'same-as-icon)
        (treemacs-create-icon :icon (format " %s " (all-the-icons-alltheicon "cplusplus" :height 0.95 :v-adjust 0.02)) :extensions ("cpp" "cxx" "hpp" "tpp" "cc" "hh") :fallback 'same-as-icon)
        ...
        (treemacs-create-icon
         :icon (format " %s " (all-the-icons-faicon "cogs" :height 0.9 :v-adjust 0.05))
